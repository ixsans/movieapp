...
class _MainPageState extends State<MainPage> {
  ...
  void initState() {
    super.initState();
    bottomNavIndex = widget.bottomNavBarIndex;
        ...
        child: Container(
          ...
          child: FloatingActionButton(
            ...
            onPressed: () {
              context
                  .bloc<PageBloc>()
                  .add(GotoTopupPageEvent(GotoMainPageEvent()));
            },
            child: SizedBox(
              height: 26,
              width: 26,
  ...
  Widget createCutomBottomNavBar() => Align(
        alignment: Alignment.bottomCenter,
        child: ClipPath(
              ...
              items: [
                BottomNavigationBarItem(
                  ...
                  icon: Container(
                      ...
                      height: 20,
                      child: Image.asset(bottomNavIndex == 0
                          ? 'assets/ic_movie.png'
                ...
                BottomNavigationBarItem(
                  ...
                  icon: Container(
                      margin: EdgeInsets.only(bottom: 6),
                      height: 20,
                      child: Image.asset(bottomNavIndex == 1
